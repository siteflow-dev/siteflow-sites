        ...
        <div className="sf-team-grid reveal">
          {team.filter(p => p.active).map(member => (
            ...
            onMouseEnter={e => {
              ...
              e.currentTarget.style.borderColor = 'rgba(199,125,186,0.4)'
            ...
            onMouseLeave={e => {
              ...
              {member.photoUrl ? (
                <img src={member.photoUrl} alt={member.name} style={{
                  width: '80px', height: '80px', borderRadius: '50%',
                  margin: '0 auto 1rem', objectFit: 'cover',
                  border: '2px solid rgba(212,175,138,0.3)',
                }} />
              ) : (
                <div style={{
                  width: '80px', height: '80px', borderRadius: '50%',
                  ...
                  color: 'var(--accent)',
                  background: 'linear-gradient(135deg, rgba(107,33,168,0.5), rgba(199,125,186,0.4))',
                  border: '2px solid rgba(212,175,138,0.3)',
                }}>
                  {member.initials}
                </div>
              ...
              <div style={{
                ...
                fontWeight: 700, color: 'var(--text-on-dark)', marginBottom: '0.25rem',
              }}>
                {member.name}
              </div>
              <div style={{ fontSize: '0.8rem', color: 'var(--accent)', marginBottom: '0.75rem' }}>
                {member.role}
              </div>
